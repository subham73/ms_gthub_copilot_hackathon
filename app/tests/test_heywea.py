import json
from ms_gthub_copilot_hackathon.heywea import heywea
...
def test_add(mock_json_file, description, priority, expected):
    todoer = heywea.Todoer(mock_json_file)
...
def test_add_wrong_json_file(mock_wrong_json_file):
    todoer = heywea.Todoer(mock_wrong_json_file)
...
def test_add_wrong_json_format(mock_wrong_json_format):
    todoer = heywea.Todoer(mock_wrong_json_format)
